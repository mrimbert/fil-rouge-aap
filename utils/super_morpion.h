...
super_morpion toSuperMorpion(char * FEN, char* trait); //Fonction qui prend en argument une chaîne FEN représentant un super morpion et renvoie l'état du super morpion correspondant
